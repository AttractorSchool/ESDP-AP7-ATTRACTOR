...
urlpatterns = [
    ...
    path('<int:pk>/parent_children_surveys/update_survey', UpdateParentChildrenSurveyView.as_view(), name='main_survey_update'),
    path('<int:pk>/parent_children_surveys/offline_study_tutor_area_survey_update',
         UpdateParentChildrenOfflineStudyTutorAreaSurveyView.as_view(), name='offline_study_tutor_area_survey_update'),
    path('<int:pk>/parent_children_surveys/offline_study_student_area_survey_update',
         UpdateParentChildrenOfflineStudyStudentAreaSurveyView.as_view(), name='offline_study_student_area_survey_update'),
    path('<int:pk>/parent_children_surveys/offline_study_tutor_area_reset',
         ResetParentChildrenOfflineStudyTutorAreaSurveyView.as_view(), name='reset_tutor_area_for_student'),
    path('<int:pk>/parent_children_surveys/offline_study_student_area_reset',
         ResetParentChildrenOfflineStudyStudentAreaSurveyView.as_view(), name='reset_student_area_for_student'),
